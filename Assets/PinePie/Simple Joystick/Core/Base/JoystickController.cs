...
namespace PinePie.SimpleJoystick
{
    ...
    public class JoystickController : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
    {
        ...
        // 입력 강도 (0~1)
        public float InputMagnitude => inputDirection.magnitude;

        // 정규화된 방향 (크기=1)
        public Vector2 InputDirectionNormalized => inputDirection.normalized;
